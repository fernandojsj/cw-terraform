...
def get_max_connections(db_instance):
    ...
    instance_memory = {
        "db.t3.micro": 1,"db.t3.small": 2,
        "db.t3.medium": 4,"db.t3.large": 8,"db.t3.xlarge": 16,
        "db.t3.2xlarge": 32,"db.t4g.micro": 1,"db.t4g.small": 2,
        "db.t4g.medium": 4,"db.t4g.large": 8,"db.t4g.xlarge": 16,
        "db.t4g.2xlarge": 32,"db.m5.large": 8,"db.m5.xlarge": 16,
        "db.m5.2xlarge": 32,"db.m5.4xlarge": 64,"db.m5.8xlarge": 128,
        "db.m5.12xlarge": 192,"db.m5.16xlarge": 256,"db.m5.24xlarge": 384,
        "db.m6g.large": 8,"db.m6g.xlarge": 16,"db.m6g.2xlarge": 32,
        "db.m6g.4xlarge": 64,"db.m6g.8xlarge": 128,"db.m6g.12xlarge": 192,
        "db.m6g.16xlarge": 256,"db.r5.large": 16,"db.r5.xlarge": 32,
        "db.r5.2xlarge": 64,"db.r5.4xlarge": 128,"db.r5.8xlarge": 256,
        "db.r5.12xlarge": 384,"db.r5.16xlarge": 512,"db.r5.24xlarge": 768,
        "db.r6g.large": 16,"db.r6g.xlarge": 32,"db.r6g.2xlarge": 64,
        "db.r6g.4xlarge": 128,"db.r6g.8xlarge": 256,"db.r6g.12xlarge": 384,
        "db.r6g.16xlarge": 512,"db.x1.16xlarge": 976,"db.x1.32xlarge": 1952,
        "db.x2g.large": 16,"db.x2g.xlarge": 32,"db.x2g.2xlarge": 64,
        "db.x2g.4xlarge": 128,"db.x2g.8xlarge": 256,"db.x2g.12xlarge": 384,
        "db.x2g.16xlarge": 512,"db.z1d.large": 16,"db.z1d.xlarge": 32,
        "db.z1d.2xlarge": 64,"db.z1d.3xlarge": 96,"db.z1d.6xlarge": 192,
        "db.z1d.12xlarge": 384,"db.m7g.large": 16,"db.m7g.xlarge": 32,
        "db.m7g.2xlarge": 64,"db.m7g.4xlarge": 128,"db.m7g.8xlarge": 256,
        "db.m7g.12xlarge": 384,"db.m7g.16xlarge": 512,"db.r7g.large": 16,
        "db.r7g.xlarge": 32,"db.r7g.2xlarge": 64,"db.r7g.4xlarge": 128,
...
def categorize_rds_instances():
    ...
    t_instance_list = []  # Lista para instâncias do tipo T (ID + tipo + Max Connections + Storage)
    ...
    try:
        ...
        for db_instance in instance_response['DBInstances']:
            ...
            instance_type = db_instance['DBInstanceClass']
            allocated_storage = db_instance['AllocatedStorage']  # Obtém o armazenamento alocado
            ...
            if not db_instance.get('DBClusterIdentifier'):
                ...
                instance_info = {
                    ...
                    "allocated_storage_gb": allocated_storage  # Armazenamento em GB
                }
...
if __name__ == "__main__":
    try:
        ...
        categorized_rds["T_instances"] = json.dumps(categorized_rds["T_instances"])
